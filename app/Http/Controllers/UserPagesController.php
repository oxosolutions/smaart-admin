<?php
  ...
  class UserPagesController extends Controller
  {
    ...
    public function index(){
        ...
        return view('userpages.index',$plugins);
    }
      ...
      return Datatables::of($model)
         ->addColumn('selector', '<input type="checkbox" name="items[]" class="icheckbox_minimal-blue item-selector" value="{{$id}}" >')
            ->addColumn('actions',function($model){
                return view('userpages._actions',['model' => $model])->render();
    ...
    public function create(){
      ...
      return view('userpages.create',$plugins);
    }
    ...
    public function store(Request $request){
        ...
        try{
            ...
            return redirect()->route('userpages.list');
        }catch(\Exception $e){
    ...
    public function edit($id){
          ...
          return view('userpages.edit',$plugins);
        }catch(\Exception $e)
        {
